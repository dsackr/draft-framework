...
4. Capability owners identified for the first mapped capabilities.
5. Acceptable-use Technology Components seeded for the most common standards.
6. Baseline deployable objects started for common Host, Runtime Service,
   Data-at-Rest Service, and Edge/Gateway patterns.
7. One real product, system, diagram, repository, or source document selected
...
### 5. Baseline Deployable Standards

...
PaaS Services follow the authoritative
[paas-service.schema.yaml](../schemas/paas-service.schema.yaml) schema and
are governed by [odc.paas-service](../configurations/odcs/odc-paas-service.yaml).

They are modeled as RBBs with:

- `type: rbb`
- `category: service`
- `serviceCategory: paas`

At minimum, a PaaS Service should include:
...
The PaaS ODC requires the architect to answer:

...
`framework/configurations/compliance-frameworks/`. Company control catalogs live
in the private workspace under `configurations/compliance-frameworks/`.
...
Each DRAFT implementation profile is a YAML file in
`framework/configurations/compliance-profiles/` for base profiles or
`configurations/compliance-profiles/` for company profiles.
...
1. add or update the pure control catalog in `configurations/compliance-frameworks/`
2. add or update the DRAFT implementation profile in `configurations/compliance-profiles/`
